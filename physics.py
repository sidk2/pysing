...
plt.grid(True)
plt.tight_layout()
plt.savefig("magnetization_vs_T_median_IQR.png")
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("specific_heat_vs_T_median_IQR.png")
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("susceptibility_vs_T_median_IQR.png")
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("autocorrelation_vs_T_median_IQR.png")
plt.close()
